...
<div class="mt-4 flex justify-center">
    <div class="p-8 w-5/6 rounded-lg" style="background-color: #173f84;"> <!-- Blue container -->
...
<div class="flex items-center justify-between mb-5 px-10">
    ...
    <a href="{{ route('admin.create') }}" class="flex items-center justify-center btn btn-primary bg-orange-500 text-white py-2 px-6 rounded-lg hover:bg-orange-600">
        <span class="material-symbols-outlined mr-2">add_2</span> <!-- Memberi jarak sedikit antara ikon dan teks -->
        Tambah Admin
    </a>
    <!-- Form Pencarian -->
