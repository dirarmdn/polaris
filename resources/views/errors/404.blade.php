...
<div class="flex flex-col items-center justify-center min-h-screen mx-auto">
    <img src="{{ asset('images/Logo.png') }}" alt="Logo" class="w-40 h-auto mb-4">
    <h1 class="text-4xl font-bold text-gray-800 mb-2">404 - Page Not Found</h1>
    <p class="text-lg text-gray-600 mb-6">Oops! The page you are looking for could not be found.</p>
